...
> Before I go ahead and rant, keep in mind that right now, Jude is in *Alpha* build. Also, **Jude is [Senseii](https://senseii.in) now!** [Prateek](https://www.prateeksingh.tech/) was also building something similar to Jude, and we decided to build this together. Senseii as a product was exactly what I had imagined Jude to be, and thus Senseii is the name we decided to stick with. 
...
2. Storing, maintaining, and updating the data **is a hassle**, & AI Chatbots are **not efficient and fast enough**.

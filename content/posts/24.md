...
Meanwhile, here's a small pixel-art generator for SVGs and PNGs written in Rust: [pixlr](https://github.com/muttonbiryani69/pixlr)
...
I built a [dribble portfolio](https://dribbble.com/muttonbiryani69) to showcase some of the posters I designed a few years ago. The next would be adding more posters, UI designs, and illustrations here. Other project updates include minor improvements to Resoc and Zuzu.
...
<img alt= 'introduction'  src ="../assets/img/24/dinos.png" class="h-75 w-75">
</figure>
...
Got a new idea about a content summarization and accessibility tool. Still in the early stages of the idea, I might share more details soon. Mostly, it would be:

...
Meanwhile, here's a small pixel-art generator for SVGs and PNGs written in Rust: [pixlr](https://github.com/anubhavp-dev/pixlr)
...
I built a [dribbble portfolio](https://dribbble.com/anubhabpatnaik) to showcase some of the posters I designed a few years ago. The next would be adding more posters, UI designs, and illustrations here. Other project updates include minor improvements to Resoc and Zuzu.

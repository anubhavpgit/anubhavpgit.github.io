...
### Projects
- **[Orion](https://github.com/fuzzymf/orion)** – A minimal application for detecing precise **muscle movements** using EMG sensors and ESP32, with a custom Python mdoule for **real-time data visualization** and implementing **ML algorithms** for muscle movement classification to simulate **mouse movements**. (*The name is inspired bt Meta's Orion project.*) (*WIP*)
...
- **[Dough](https://github.com/fuzzymf/dough)** – A high-performance CLI presentation tool in Rust that renders markdown files as slides with custom syntax highlighting and efficient text processing.
- **[Bee](https://github.com/fuzzymf/b)** – A custom **BitTorrent client** with an item-based collaborative recommendation system using cosine similarity and a rating prediction system achieving **95%** accuracy.
...
- **[Rokio](https://github.com/fuzzymf/rust-tokio-chat-server)** – A **multi-client chat server** in Rust using Tokio for asynchronous concurrency.

class Instruction {
  ...
  colorCodeR(instruction) {
    return `
      <span id="funct7" style="color: #FFD580;"
  ...
  colorCodeI(instruction) {
    return `
      <span id="imm" style="color: #FFD580;"

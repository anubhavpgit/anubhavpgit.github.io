...
\resumeProjectHeading
  {\href{https://anubhavp.dev/blog/hacktoberfest}{\textbf{Compilers} - \faIcon{link}}}{C++}
    \resumeSubItem
      {Ferry - A high-performant, {\href{https://anubhavp.dev/blog/ferryman.html} {\underline{\textbf{minimal C lang compiler}}}} for RISC-V written in Rust, \& a five-stage, hazard \& Yatch - a memory-safe 32-bit pipelined machine code interpreter with a built-in binary {\href{https://anubhavp.dev/barney}{\underline{\textbf{decoder}}} for RISC-V}. $\rightarrow$ {\href{https://anubhavp.dev/blog/hacktoberfest.html}{\textbf{Demo}}}}
  \resumeProjectHeading

...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading
    {YourMove.AI}{New York, US}
    {\textbf{Product Engineer}}{May 2025 | Present}
    \resumeItemListStart
      \resumeItem
        {Built user engagement tools (\href{https://yourmove.ai/date-ideas}{date-ideas generator}, \href{https://yourmove.ai/date-coach}{dating coach}, \href{https://yourmove.ai/cosmic-compatibility}{zodiac-compatibility analyzer}) generating 300k+ views through organic marketing; improved SEO and user experience while optimizing content using Ahrefs, Google Analytics, and Google Search Console, increasing revenue by 3-5\%; enhanced core product using Node.js, Ionic, and Capacitor to improve user retention.}   
      \resumeItemListEnd
    \resumeSubheading
    {h011yw00d}{San Francisco, US}
    {\textbf{AI Research Engineer Intern}}{ May 2025 | Present}
    \resumeItemListStart
      \resumeItem
...
\section{Projects}
  ...
  \resumeProjectHeading
    ...
    \resumeSubItem
      {A decentralized chat app enabling low-latency, secure, and ephemeral messaging with more than \href{https://anubhavp.dev/assets/img/current/fireside-metrics.webp}{\underline{{20k active users}}}. {\href{https://anubhavp.dev/fireside/}{\textbf{Live°}}}}
  \resumeSubHeadingListEnd
%-------------------------------------------

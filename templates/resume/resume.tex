...
\section{Experience}
  ...
  \resumeSubheading
    ...
    \resumeItem
        {Built a Worldcoin native app. Won the world builder residency gaining more than 0.1M impressions in the app in 3 days!}
    \resumeItemListEnd
    \resumeSubheading
      {RadiusAI}{Seattle, US}
